...
train_data_set = Data("E:/mini/dataset/CASIA_scale/scale_2.2/",True)
test_data_set = Data("E:/mini/dataset/CASIA_scale/scale_2.2/",False)
...
if __name__ == '__main__':
    ...
    train(net,train_data_loader,optimizer,1)